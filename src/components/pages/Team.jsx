...
const EXECOM_MEMBERS_2025 = [
    ...
    // MEDIA
    mk('Ismail Khan', 'Media Head', 'MEDIA', img('Ismail Khan(1).jpeg'), {}),
...
// ─────────────────────────────────────────
const TeamHero = () => (
    <section className="relative min-h-[60vh] pt-24 pb-16 md:pt-32 md:pb-20 flex flex-col items-center justify-center px-6 bg-white overflow-hidden">
        <AnimatedBackground />
